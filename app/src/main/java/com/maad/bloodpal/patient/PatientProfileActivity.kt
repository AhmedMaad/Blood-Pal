    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        db
            ...
            .addOnSuccessListener {
                ...
                binding.bloodBagsValueTv.text =
                    it.getString("bloodBags") ?: "No Information Available"
                binding.diagnosisValueTv.text =
                    it.getString("diagnosis") ?: "No Information Available"
